...
export const AddUpdateUser = ({ user }: any) => {
    ...
    const userSchema = z.object({
        ...
        if (user && (!data.password || data.password === "" || data.password === null)) {
            return true;
        } else {
    ...
    return (
        <div>
            <h1 className="font-bold text-xl p-2 mb-4">{!user ? u("adduser") : u("updateuser")}</h1>
            <Form {...form}>
